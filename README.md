...
□ I AM **CHAOGEJILATU**, AN ENVIRONMENTAL SCIENTIST FOCUSED ON TURNING **EARTH OBSERVATION AND GEOSPATIAL DATA** INTO DECISION-READY INSIGHTS FOR CLIMATE RISK AND AGRICULTURAL RESILIENCE.  
□ CURRENTLY BASED IN **TSUKUBA, JAPAN**, I WORK AT THE **NATIONAL AGRICULTURE AND FOOD RESEARCH ORGANIZATION (NARO)**.

---

## 🧪 RESEARCH FOCUS
- **CLIMATE CHANGE & FOOD SECURITY** (RISK, IMPACTS, RESILIENCE)
- **LAND USE / LAND COVER CHANGE** AND ENVIRONMENTAL SUSTAINABILITY
- **REMOTE SENSING × GIS × STATISTICAL MODELING** (REPRODUCIBLE ANALYTICS)
- **INTERNATIONAL COLLABORATION** ACROSS EAST ASIA AND GLOBAL NETWORKS

---

## 🧭 BACKGROUND
AS A MONGOLIAN RESEARCHER AND A DESCENDANT OF **TOLEI** (THE FOURTH SON OF **GENGHIS KHAN**),  
I AIM TO CONNECT **SCIENCE AND HERITAGE**, LINKING TRADITIONAL PERSPECTIVES WITH MODERN GLOBAL CHALLENGES.
